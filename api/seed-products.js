...
const products = [
  ...
  { name: "Nothing Phone (2a) 5G", description: "Dimensity 7200 Pro, unique Glyph Interface LED, 50MP camera, 120Hz AMOLED, transparent design", category: "smartphones", brand: "Nothing", price: 23999, rating: 4.4, reviews: 9800, image: "https://images.unsplash.com/photo-1606077095660-726118e877fd?w=400&h=400&fit=crop" },
  ...
  { name: "Apple AirPods Pro 2nd Generation", description: "Active noise cancellation, transparency mode, personalised spatial audio, MagSafe case", category: "audio", brand: "Apple", price: 19900, rating: 4.7, reviews: 31200, image: "https://images.unsplash.com/photo-1675703342284-cf59dc6f98e3?w=400&h=400&fit=crop" },
  ...
  { name: "Sony WF-1000XM5 Wireless Earbuds", description: "Smallest noise cancelling earbuds, LDAC Hi-Res Audio, 24hr battery with case, IPX4", category: "audio", brand: "Sony", price: 21990, rating: 4.6, reviews: 14800, image: "https://images.unsplash.com/photo-1754142654807-1dfcdc3f7f22?w=400&h=400&fit=crop" },
  ...
  { name: "MSI Stealth 16 Studio Laptop", description: "Intel Core i9-13900H, RTX 4070, 32GB RAM, 16-inch QHD+ 240Hz, creator and gaming beast", category: "laptops", brand: "MSI", price: 199999, rating: 4.7, reviews: 3200, image: "https://images.unsplash.com/photo-1630794180018-433d915c34ac?w=400&h=400&fit=crop" },
  ...
  { name: "HyperX Cloud III Wireless Gaming Headset", description: "DTS Spatial Audio, 53mm drivers, 120hr battery, detachable mic, memory foam earpads", category: "gaming accessories", brand: "HyperX", price: 10999, rating: 4.5, reviews: 8300, image: "https://images.unsplash.com/photo-1673669231301-09baa4d7761b?w=400&h=400&fit=crop" },
  { name: "Xbox Elite Series 2 Wireless Controller", description: "Adjustable tension thumbsticks, shorter hair trigger locks, wrap-around rubberised grip, 40hr battery", category: "gaming accessories", brand: "Microsoft", price: 14999, rating: 4.6, reviews: 11200, image: "https://images.unsplash.com/photo-1482855549413-2a6c9b1955a7?w=400&h=400&fit=crop" },
  ...
  { name: "BenQ EW3280U 32-inch 4K HDR Monitor", description: "32-inch 4K IPS, HDRi technology, treVolo speakers, USB-C 60W, eye-care tech", category: "monitors", brand: "BenQ", price: 44999, rating: 4.6, reviews: 4100, image: "https://images.unsplash.com/photo-1706048121567-ab03628a36d2?w=400&h=400&fit=crop" },
  { name: "Asus ProArt PA278QV 27-inch WQHD Monitor", description: "2560x1440 IPS, 100% sRGB and Rec.709, factory pre-calibrated Delta E < 2, 75Hz", category: "monitors", brand: "Asus", price: 31999, rating: 4.7, reviews: 3500, image: "https://images.unsplash.com/photo-1606223226391-c267641c318c?w=400&h=400&fit=crop" },
  ...
  { name: "WD Black SN850X 2TB NVMe SSD", description: "PCIe Gen 4, 7300MB/s read, Game Mode 2.0, heatsink included, predictive loading", category: "storage", brand: "WD", price: 14999, rating: 4.7, reviews: 8400, image: "https://images.unsplash.com/photo-1719937206300-fc0dac6f8cac?w=400&h=400&fit=crop" },
  ...
  { name: "Samsung T7 Shield 1TB Portable SSD", description: "IP65 rated, 1050MB/s read, USB 3.2, shock resistant rubber exterior, compact design", category: "storage", brand: "Samsung", price: 7999, rating: 4.6, reviews: 13200, image: "https://images.unsplash.com/photo-1756836857570-127b0408b676?w=400&h=400&fit=crop" },
  ...
  { name: "Xiaomi Smart Band 8 Pro", description: "1.74-inch AMOLED, 200+ workout modes, SpO2, 14-day battery, GPS, always-on display", category: "wearables", brand: "Xiaomi", price: 3499, rating: 4.4, reviews: 42000, image: "https://images.unsplash.com/photo-1576243345690-4e4b79b63288?w=400&h=400&fit=crop" },
  { name: "Garmin Venu 3 Smartwatch", description: "AMOLED display, body battery energy monitor, sleep coach, wheelchair mode, 14-day battery", category: "wearables", brand: "Garmin", price: 49990, rating: 4.7, reviews: 5600, image: "https://images.unsplash.com/photo-1722445423163-f57f92ea9f78?w=400&h=400&fit=crop" },
